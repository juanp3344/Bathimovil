...
namespace Unitarias
{
    public class DatosHelper
    {
        ...
        public static Tipos_Implementos GetTipo_Implemento(int id = 1) => new Tipo_Implementos
        {
            Id_Tipo_Implementos = id,
        ...
        public static Mantenimientos GetMantenimiento(int id = 1, int idPrestamo = 1, int idEmpleado = 1, int idPortatil = 1) => new Mantenimiento
        {
            Id_Mantenimiento = id,
